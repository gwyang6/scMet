...
def visualize_cell_type_proportions(cell_type_proportions_df):
    ...
    if save_path is None:
        save_path_NMF = os.path.join(os.getcwd(), "output/celltype_proportion.png")
    plt.savefig(save_path_NMF,dpi=1000)
    plt.show()
    print(f"Celltype proportion plots will be saved to: {save_path_NMF}")
