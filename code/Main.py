...
parser.add_argument('--batch_size', nargs='?', type=int, default=720,
...
parser.add_argument('--Std', nargs='?', type=int, default=0.135,
...
parser.add_argument('--num_simulations_cell', nargs='?', type=int, default=10000,
...
save_path = os.path.join(os.getcwd(), "output/simulation_adata.h5ad")
adata.write(save_path)
print(f"adata haved been saved to: {save_path}")
print("The output results are all in the output folder, please check")
